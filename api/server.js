...
async function fetchAndStoreMatches() {
  try {
    ...
    // If no matches found, use demo matches
    if (matches.length === 0) {
    ...
    // If API fails and no matches exist, use demo
...
// This runs once when Vercel starts the function
